    ...
    <div class="p-6 mx-auto max-w-md">
        ...
        <div class="flex flex-col p-4 mb-4 space-y-6 bg-white rounded-lg shadow-lg">
            ...
            <div x-data="{open:false}">
                ...
                <button @click="open = !open" class="px-4 py-2 w-full text-white bg-blue-500 rounded-lg hover:bg-blue-600">
                ...
                <div x-show="open" class="mt-5">
                    <form wire:submit="store">
                        ...
                        <div class="flex items-center mt-4">
                            <input wire:model="isRevised" id="default-checkbox" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
